...
export const MetadatasFormFrTranslations: Translations<"fr">["MetadatasForm"] = {
    ...
    "metadata.description_form.additional_access_constraints": "Contraintes d'accès supplémentaires",
    "metadata.description_form.additional_use_constraints": "Contraintes d'usage supplémentaires",
    ...
    "metadata.description_form.access_constraint_name": "Intitulé de la contrainte d'accès",
    "metadata.description_form.access_constraint_link": "Lien de la contrainte d'accès",
    ...
    "metadata.description_form.use_constraint_name": "Intitulé de la contrainte d'usage",
    "metadata.description_form.use_constraint_link": "Lien de la contrainte d'usage",
