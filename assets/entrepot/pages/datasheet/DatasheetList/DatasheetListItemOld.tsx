...
type DatasheetListItemOldProps = {
    datastoreId: string;
    datasheet: Datasheet;
};

const DatasheetListItemOld: FC<DatasheetListItemOldProps> = ({ datastoreId, datasheet }) => {
...
DatasheetListItemOld.displayName = symToStr({ DatasheetListItemOld });
export default DatasheetListItemOld;
