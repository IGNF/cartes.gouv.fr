...
class CartesMetadataApiService
{
     ...
     */
    public function createOrUpdateFromDto(string $datastoreId, string $datasheetName, DatasheetServices $services, DatasheetMetadataDTO $dto): array
    {
        $apiMetadata = $this->getMetadataByDatasheetName($datastoreId, $datasheetName);
    ...
    private function getNewCswMetadataFromDto(string $datastoreId, DatasheetServices $services, ?CswMetadata $oldCswMetadata, DatasheetMetadataDTO $dto): CswMetadata
    {
        ...
        $newCswMetadata->layers = $this->getMetadataLayers($datastoreId, $services);
