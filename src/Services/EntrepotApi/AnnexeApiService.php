...
final class AnnexeApiService
{
    ...
    {
        return $this->api->get("datastores/$datastoreId/annexes", $query)->jsonWithHeaders();
    }
    ...
    public function get(string $datastoreId, string $annexeId): PendingResponse
    {
    ...
    public function add(string $datastoreId, string $annexeFilePath, array $paths, ?array $labels = null, bool $published = true): array
    {
        ...
        if (null !== $labels) {
            $response = $this->modify($datastoreId, $response['_id'], null, $labels, null)->json();
        }
     ...
     * @param array<string> $labels
     */
    public function modify(string $datastoreId, string $annexeId, ?array $paths = null, ?array $labels = null, ?bool $published = null): PendingResponse
    {
        $body = [];
    ...
    {
        $response = $this->api->sendFile('PUT', "datastores/$datastoreId/annexes/$annexeId", $annexeFilePath)->json();
    ...
    public function publish(string $datastoreId, string $annexeId): PendingResponse
    {
    ...
    public function remove(string $datastoreId, string $annexeId): PendingResponse
    {
        return $this->api->delete("datastores/$datastoreId/annexes/$annexeId");
    }

    public function download(string $datastoreId, string $annexeId): PendingResponse
    {
