...
#[OA\Tag(name: '[espaceco] community-documents', description: 'Documents liés à une communauté')]
class CommunityDocumentController extends AbstractController implements ApiControllerInterface
{
    ...
    public function getAll(
        ...
        try {
            $response = $this->communityDocumentApiService->getDocuments($communityId, $fields)->json();
    ...
    public function updateDocument(int $communityId, int $documentId, Request $request): JsonResponse
    {
        try {
            ...
            $response = $this->communityDocumentApiService->updateDocument($communityId, $documentId, $data)->json();
    ...
    {
        try {
            $this->communityDocumentApiService->deleteDocument($communityId, $documentId)->wait();
